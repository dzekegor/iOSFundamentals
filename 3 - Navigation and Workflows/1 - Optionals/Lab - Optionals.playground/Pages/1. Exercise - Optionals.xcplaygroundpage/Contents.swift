...
print(userAge)
// There's a typo, Int function can't convert it to a number
/*:
 ...
 */
// It returns an optional value because an argument can be not acceptable even if the type of it is right.
print(userAge!)
